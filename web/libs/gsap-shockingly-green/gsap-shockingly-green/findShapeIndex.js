...
function findShapeIndex(target, endShape, vars) {
    ...
    var _doc = document,
        ...
        _setup = function() {
            ...
            gsap.set(e, {'z-index': 9999999, padding:"0px", position:"absolute", bottom:0, fontSize:"20px", textAlign:"center", backgroundColor: "black", color:"#91e600", border:"1px solid #999", left:"50%", xPercent:-50, yPercent:-50, userSelect:"none", fontFamily:"sans-serif"});
